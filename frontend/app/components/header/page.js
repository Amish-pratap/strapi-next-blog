...
import { destroyCookie } from "next-cookies"; // Import useCookies from next-cookies
...
const Header = () => {
  ...
  const handleLogout = () => {
    // Clear the cookie and set authUser to null
        ...
        <div className="bg-white shadow">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between py-4">
              ...
              <div className="hidden sm:flex sm:items-center">
                {/* Conditionally render based on authUser */}
                {authUser ? (
                  <>
